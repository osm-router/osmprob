...
Figure 7 shows how the calculation time is affected by the graph size. It also
...
```{r echo=FALSE, fig.cap="Figure 7: Performance analysis of omsprob"}
...
dat_bm$dl_time %<>% as.character %>% as.numeric
