...
@hall2012handbook. And whilst some of these rely on probabilities in order to
...
formats OpenStreetMap data. The package is authored and maintained by @osmdata.
...
@saerens2009randomized refer to as $\eta$. Its value describes the global
entropy that the routing algorithm uses. 
Part of this paper is to understand
...
an influence on calculation time. Specifically, lower values for $\eta$ appear
to be leading to longer calculation times.
