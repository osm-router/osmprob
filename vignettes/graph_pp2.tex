...
\tikzstyle{edge_style2} = [lightgray, line width=1]
    ...
    \draw[edge_style1] (v1) edge (v2);
    \draw[edge_style1] (v1) edge (v7);
    \draw[edge_style1] (v1) edge (v9);
    \draw[edge_style1] (v1) edge (v10);
    \draw[edge_style1] (v2) edge (v3);
    \draw[edge_style1] (v3) edge (v4);
    \draw[edge_style1] (v3) edge (v7);
    \draw[edge_style1] (v3) edge (v8);
    \draw[edge_style1] (v4) edge (v5);
    \draw[edge_style1] (v5) edge (v6);
    \draw[edge_style1] (v6) edge (v7);
    \draw[edge_style1] (v8) edge (v9);
