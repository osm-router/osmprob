\begin{tikzpicture}
\tikzstyle{node_style1} = [draw=white, circle,fill=teal]
\tikzstyle{node_style2} = [circle,fill=blue!60]
\tikzstyle{node_style3} = [circle,fill=orange]
\tikzstyle{node_style4} = [circle,fill=violet]
